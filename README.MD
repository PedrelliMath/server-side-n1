...
### CRIANDO TRANSAÇÃO CRÉDITO

* Faça uma requisição com método `POST` em `http://0.0.0.0:9999/clientes/{id}/transacoes` passando no corpo da requisição o JSON com os dados.
